...
public class FDCalculator {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.get(
				"https://www.moneycontrol.com/fixed-income/calculator/state-bank-of-india-sbi/fixed-deposit-calcultor-SBI-858001.html");
		...
		for (int i = 1; i <= rows; i++) {
			...
			Select perdrp = new Select(driver.findElement(By.xpath("//select [@id='tenure Period']")));
			...
			if (Double.parseDouble(exp_mvalue) == Double.parseDouble(act_mvalue)) {
				...
				ExcelUtils.setCellData(filePath, "Sheet1", 1, 7, "Passed");
